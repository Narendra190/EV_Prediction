...
st.markdown("""
    <style>
        body {
            background: linear-gradient(120deg, #e0eafc 0%, #cfdef3 40%, #f9f9f9 100%);
            color: #232946;
        }
        .stApp {
            background: linear-gradient(120deg, #a8edea 0%, #fed6e3 50%, #fcb69f 100%);
        ...
        .st-bw {
            background-color: #fed6e3 !important;
        }
        .st-cq {
